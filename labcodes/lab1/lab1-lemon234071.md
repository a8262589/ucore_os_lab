...
栈中最深层为第一个被调用信息，booblock.asm第100行中可看到设置栈区域为0--start(0x7c00)，call bootmain。  
0x00007bf8为bootmain的ebp，观察bootblock.asm可知0x00007d66为bad:开始outw地址，因bootmain没有参数，观察bootblock.asm可知args为栈底0x7c00起四个地址。 
...
答：  
8字节，31-16位为选择子，63-48和15-0共同构成偏移，二者形成入口。

2、3、依照注释填写代码  

对比参考答案，需要进一步了解系统调用，以及中断SETGATE参数设定，来进一步完成challenge