...
do_pgfault(struct mm_struct *mm, uint32_t error_code, uintptr_t addr) {
    ...
    */
    ...
    /*LAB3 EXERCISE 2: lemon234071
    * Now we think this pte is a  swap entry, we should load data from disk to a page with phy addr, and map the phy addr with logical addr, trigger swap manager to record the access situation of this page.
    *
    *  Some Useful MACROs and DEFINEs, you can use them in below implementation.
    *  MACROs or Functions:
